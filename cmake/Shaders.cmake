...
# build needs a translation step.
#
# That step was expected to be impossible for falling_sand.comp. WGSL forbids a storage buffer
# being both atomic and non-atomic -- a binding is array<atomic<u32>> or array<u32>, never both --
# and that shader reads the grid plainly in seventy-six places and atomically in seventy-two. The
# rule is real; the conclusion drawn from it here, that no translator could emit legal WGSL, was
# wrong. naga does exactly what a person would have had to: declares the binding array<atomic<u32>>
# and routes the plain accesses through atomicLoad and atomicStore. All three shaders translate.
#
# So: a committed translation in shaders/wgsl wins if present (that is the normal case, produced by
# tools/gen_wgsl.sh), and tint is a fallback for a checkout that somehow lacks one.
